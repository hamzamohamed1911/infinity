  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button className="fixed z-50 lg:left-20 md:left-10 left-5 bottom-10 text-primary flex p-4 justify-center items-center text-2xl font-semibold bg-white shadow-xl gap-2 rounded-full transition-all hover:translate-y-1 duration-700">
