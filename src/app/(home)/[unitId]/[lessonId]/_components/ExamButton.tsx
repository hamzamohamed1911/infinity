  ...
  return (
    <div className="flex flex-col gap-4 justify-center items-center mt-8">
      <button
        ...
        className="bg-primary-500 hover:bg-primary-600 text-white rounded-md group flex gap-2 items-center justify-center w-52 lg:h-16 md:h-14 h-12 disabled:opacity-50 disabled:cursor-not-allowed"
      >
