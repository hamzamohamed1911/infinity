  ...
  return (
    <>
      <div className=" px-6">
        {/* Question Card */}
        <Card className="mb-6">
          <CardContent className="p-8 flex flex-col md:gap-6 gap-4">
            {/* End Exam Button */}
            ...
            {currentQuestion.type_id === "text" && (
              <div className="flex flex-col gap-4">
                ...
                <div className="mb-4 rounded-3xl  ">
                  ...
                  <label
                    htmlFor="imageUpload"
                    className="mt-3 flex gap-2 w-fit bg-primary text-white px-6 py-3 rounded-md justify-center items-center cursor-pointer"
                  >
            ...
            <div className="flex items-center justify-between">
              <Button
                ...
                variant="outline"
                className="flex items-center gap-2 text-white bg-primary-500 hover:bg-primary-400 hover:text-white h-12"
              >
              ...
              <Button
                onClick={goToNextQuestion}
                className="flex items-center gap-2 text-white bg-primary-500 hover:bg-primary-400 h-12"
              >
